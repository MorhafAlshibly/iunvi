...
func (x *CreateWorkspaceResponse) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
func (x *EditWorkspaceRequest) GetId() []byte {
	if x != nil {
		return x.Id
	}
	return nil
...
var file_api_tenantManagement_proto_rawDesc = string([]byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x69, 0x64, 0x22, 0x16, 0x0a, 0x14, 0x47, 0x65,
	...
	0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x2f, 0x0a, 0x09, 0x57, 0x6f, 0x72, 0x6b,
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x54, 0x0a, 0x04, 0x55, 0x73, 0x65,
	...
	0x28, 0x09, 0x52, 0x0b, 0x64, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x32,
	0xb0, 0x02, 0x0a, 0x17, 0x54, 0x65, 0x6e, 0x61, 0x6e, 0x74, 0x4d, 0x61, 0x6e, 0x61, 0x67, 0x65,
	...
	0x2f, 0x4d, 0x6f, 0x72, 0x68, 0x61, 0x66, 0x41, 0x6c, 0x73, 0x68, 0x69, 0x62, 0x6c, 0x79, 0x2f,
	0x69, 0x75, 0x6e, 0x76, 0x69, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x62, 0x06, 0x70,
...
var file_api_tenantManagement_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_api_tenantManagement_proto_goTypes = []any{
	...
	(*Workspace)(nil),               // 8: api.Workspace
	(*User)(nil),                    // 9: api.User
}
var file_api_tenantManagement_proto_depIdxs = []int32{
	8, // 0: api.GetWorkspacesResponse.workspaces:type_name -> api.Workspace
	9, // 1: api.GetUsersResponse.users:type_name -> api.User
	0, // 2: api.TenantManagementService.CreateWorkspace:input_type -> api.CreateWorkspaceRequest
	2, // 3: api.TenantManagementService.GetWorkspaces:input_type -> api.GetWorkspacesRequest
	4, // 4: api.TenantManagementService.EditWorkspace:input_type -> api.EditWorkspaceRequest
	6, // 5: api.TenantManagementService.GetUsers:input_type -> api.GetUsersRequest
	1, // 6: api.TenantManagementService.CreateWorkspace:output_type -> api.CreateWorkspaceResponse
	3, // 7: api.TenantManagementService.GetWorkspaces:output_type -> api.GetWorkspacesResponse
	5, // 8: api.TenantManagementService.EditWorkspace:output_type -> api.EditWorkspaceResponse
	7, // 9: api.TenantManagementService.GetUsers:output_type -> api.GetUsersResponse
